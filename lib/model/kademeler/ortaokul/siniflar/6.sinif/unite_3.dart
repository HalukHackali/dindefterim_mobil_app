...
class Alti_C_Ucuncu_Unite extends StatefulWidget {
  const Alti_C_Ucuncu_Unite();

  @override
  _Alti_C_Ucuncu_UniteState createState() => _Alti_C_Ucuncu_UniteState();
}

class _Alti_C_Ucuncu_UniteState extends State<Alti_C_Ucuncu_Unite> {
  bool shouldPop = true;
                    ...
                    child: Column(
                      children: [
                        ...
                        unitAltKonuAdiBant(context,
                          ...
                          const UniteIcerik(
                            konuAdi: 'Bazı Zararlı Alışkanlıklar',
                        ...
                        unitAltKonuAdiBant(context,
                          ...
                          const UniteIcerik(
                            konuAdi: 'Zararlı Alışkanlıklara Başlama Sebepleri',
                            mdLinkF: KonuIcerikMarkDown(
                              mdLink:
                        ...
                        unitAltKonuAdiBant(
                          ...
                          const UniteIcerik(
                            konuAdi: 'Zararlı Alışkanlıklardan Korunma Yolları',
                            mdLinkF: KonuIcerikMarkDown(
                              mdLink:
                        ...
                        unitAltKonuAdiBant(
                          ...
                          const UniteIcerik(
                            konuAdi: 'Bir Peygamber Tanıyorum: Hz.Yahya(as)',
                            mdLinkF: KonuIcerikMarkDown(
                              mdLink:
                        ...
                        unitAltKonuAdiBant(
                          ...
                          const UniteIcerik(
                            konuAdi: 'Bir Sure Tanıyorum: Tebbet Suresi ve Anlamı',
                            mdLinkF: KonuIcerikMarkDown(
                              mdLink:
