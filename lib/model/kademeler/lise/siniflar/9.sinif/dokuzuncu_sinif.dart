...
class DokuzuncuSinif extends StatefulWidget {
  const DokuzuncuSinif({Key? key}) : super(key: key);

  @override
  _DokuzuncuSinifState createState() => _DokuzuncuSinifState();
}

class _DokuzuncuSinifState extends State<DokuzuncuSinif> {
  @override
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: const TabBarView(
          children: [
            Dokuz_A_Birinci_Unite(),
            Dokuz_B_Ikinci_Unite(),
            Dokuz_C_Ucuncu_Unite(),
            Dokuz_D_Dorduncu_Unite(),
            Dokuz_E_Besinci_Unite(),
          ],
        ),
      ),
    );
